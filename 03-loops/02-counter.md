...
p5.draw = function () { p5.background(245); for (let i = 0; i < 12; i += 1) { p5.rect(i * 50, 100, 35, i * 8); } };
```
@P5.eval
## MISSION
@JSQ.mission
...
```js
p5.setup = function () { p5.createCanvas(600, 300); };
p5.draw = function () { p5.background(245); // TODO: Opakuj kreslení schodu. // TODO: Spoj index s výškou. };
```
@P5.eval
