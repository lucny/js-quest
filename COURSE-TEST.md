...
- [ ] WebDev bloky WORLD 8 vykreslí HTML a obslouží selector, click i input.
- [ ] Lokální odkazy, navigace, UTF-8, české znaky a systémový font jsou správně.
- [ ] Light/dark mode a úzký viewport zachovají čitelnost.

## LiaScript

- [ ] Nezobrazují se doslovné HTML tagy ani párové wrappery.
- [ ] Nikde nevzniká nechtěné tlačítko Submit ani Task formulář.
...
- [ ] Predict skutečně předchází Run v reprezentativních lekcích každého WORLDu.
- [ ] Obtížnost roste od proměnných přes data a interakci k vlastnímu projektu.
